      ...
      <div className="max-w-md mx-auto flex justify-around items-center h-16">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center flex-1 h-full transition-colors ${
            isActive('/') && !location.pathname.includes('/pokemon/') && !location.pathname.includes('/types') && !location.pathname.includes('/trainers')
        ...
        >
          ...
          <span className="text-xs font-semibold">Pokédex</span>
        </button>
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center flex-1 h-full transition-colors ${
            isActive('/trainers') ? 'text-purple-600 dark:text-purple-400' : 'text-gray-500 dark:text-gray-400'
          }`}
        >
          <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
          ...
          <span className="text-xs font-semibold">Trainers</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-semibold">Types</span>
        </button>
