...
export const pokemonDatabase: Pokemon[] = [
  ...
  { id: 10015, name: 'Mega Beedrill', types: ['bug', 'poison'] },
  { id: 10018, name: 'Mega Pidgeot', types: ['normal', 'flying'] },
  { id: 10065, name: 'Mega Alakazam', types: ['psychic'] },
  { id: 10080, name: 'Mega Slowbro', types: ['water', 'psychic'] },
  { id: 10094, name: 'Mega Gengar', types: ['ghost', 'poison'] },
  { id: 10130, name: 'Mega Gyarados', types: ['water', 'dark'] },
  { id: 10142, name: 'Mega Aerodactyl', types: ['rock', 'flying'] },
  { id: 10149, name: 'Mega Dragonite', types: ['dragon', 'flying'] },
  { id: 10003, name: 'Mega Venusaur', types: ['grass', 'poison'] },
  { id: 10006, name: 'Mega Charizard X', types: ['fire', 'dragon'] },
  { id: 20006, name: 'Mega Charizard Y', types: ['fire', 'flying'] },
  { id: 10009, name: 'Mega Blastoise', types: ['water'] },
  { id: 10181, name: 'Mega Ampharos', types: ['electric', 'dragon'] },
  { id: 10212, name: 'Mega Scizor', types: ['bug', 'steel'] },
  { id: 10208, name: 'Mega Steelix', types: ['steel', 'ground'] },
  { id: 10248, name: 'Mega Tyranitar', types: ['rock', 'dark'] },
  { id: 10302, name: 'Mega Sableye', types: ['dark', 'ghost'] },
  { id: 10303, name: 'Mega Mawile', types: ['steel', 'fairy'] },
  { id: 10306, name: 'Mega Aggron', types: ['steel'] },
  { id: 10308, name: 'Mega Medicham', types: ['fighting', 'psychic'] },
  { id: 10310, name: 'Mega Manectric', types: ['electric'] },
  { id: 10319, name: 'Mega Sharpedo', types: ['water', 'dark'] },
  { id: 10323, name: 'Mega Camerupt', types: ['fire', 'ground'] },
  { id: 10334, name: 'Mega Altaria', types: ['dragon', 'fairy'] },
  { id: 10354, name: 'Mega Banette', types: ['ghost'] },
  { id: 10359, name: 'Mega Absol', types: ['dark'] },
  { id: 10373, name: 'Mega Salamence', types: ['dragon', 'flying'] },
  { id: 10376, name: 'Mega Metagross', types: ['steel', 'psychic'] },
  { id: 10448, name: 'Mega Lucario', types: ['fighting', 'steel'] },
  { id: 10445, name: 'Mega Garchomp', types: ['dragon', 'ground'] },
  { id: 10460, name: 'Mega Abomasnow', types: ['grass', 'ice'] },
  ...
  { id: 10115, name: 'Mega Kangaskhan', types: ['normal'] },
  { id: 10127, name: 'Mega Pinsir', types: ['bug', 'flying'] },
  { id: 10214, name: 'Mega Heracross', types: ['bug', 'fighting'] },
  { id: 10428, name: 'Mega Lopunny', types: ['normal', 'fighting'] },
  { id: 10531, name: 'Mega Audino', types: ['normal', 'fairy'] },
  { id: 10362, name: 'Mega Glalie', types: ['ice'] },
  ...
  { id: 10282, name: 'Mega Gardevoir', types: ['psychic', 'fairy'] },
  { id: 10475, name: 'Mega Gallade', types: ['psychic', 'fighting'] },
  { id: 10229, name: 'Mega Houndoom', types: ['dark', 'fire'] },
